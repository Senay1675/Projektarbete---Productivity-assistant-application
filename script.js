...
// if (filter === "streak"){
console.log(a);
let habitB = b.querySelector(".habit-card div:nth-child(4) > div").textContent;
  let habitA = a.querySelector(".habit-card div:nth-child(4) > div").textContent;
...
const makeHabitcard = (habitStreak, habitPriority, habitTitle) => {
 ...
 const deleteFuncButton = (button) =>{
   ...
   const updatedHabitList = habitCard.filter((item) => item.cardID !== +cardId);
